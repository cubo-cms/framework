...
export default class Model extends Core {
  ...
  /** @function driver(data)
    ...
    **/
  driver(data = {}) {
    if(this.source.driver || Model.default.driver) {
      let driverType = this.source.driver || Model.default.driver;
      if(Driver.exists(driverType)) {
        Log.info(`Model starts driver instance for \"${driverType}\"`);
        let driver = Driver.construct(driverType, data, this);
        driver.model = this;
        driver.source = this.source;
        return driver;
      } else {
